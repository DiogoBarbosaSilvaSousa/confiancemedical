...
export default function Sugestao({sistemaSugestao, aoEnviarSugestao}) {
...
/*********************** **************** ************************/
    ...
    const incluirMonitor = (event) => {
      ...
      aoEnviarSugestao({monitor: info_monitor, tipo_monitor: info_tipo_monitor, imagem_monitor: info_imagem_monitor});

      //event.target.classList.toggle('red');

      // alert("Monitor selecionado: " + event.target.dataset.imagem);

      console.log(sistemaSugestao);
      ...
      return (
            ...
            >
              <Grid container spacing={0}>
                  ...
                  <Grid item xs={10}>
                      <DialogTitle id="max-width-dialog-title" className="sugestao-titulo-opcao"><Icon className="fa fa-angle-left icone" /> ADICIONAR MÓDULO</DialogTitle>
                  </Grid>
                  ...
                  <Grid item xs={2}>
                    ...
                    <DialogActions>
                      <Link href="#" onClick={handleCloseMonitores}>
                          <Icon className="fas fa-times sugestao-icone-fechar" />
                      </Link>
                    </DialogActions>
              ...
              <DialogContent>
                  <DialogContentText className="sugestao-subtitulo-opcao">
                      MONITORES
                  </DialogContentText>
...
/*********************** ******************* ************************/
    ...
    const incluirInsuflador = (event) => {
      ...
      aoEnviarSugestao({insuflador: info_insuflador, imagem_insuflador: info_imagem_insuflador});
...
/*********************** ************** ************************/
    ...
    const handleCloseCameras = (event) => {
     ...
     const incluirCamera = (event) => {
      ...
      aoEnviarSugestao({camera: info_camera,tipo_camera: info_tipo_camera,imagem_camera: info_imagem_camera});
...
/*********************** ************ ************************/
    ...
    const incluirLuz = (event) => {
      ...
      aoEnviarSugestao({luz: info_luz, imagem_luz: info_imagem_luz});
...
/*********************** ***************** ************************/
    ...
    const incluirGravador = (event) => {
      ...
      aoEnviarSugestao({gravador: info_gravador, imagem_gravador: info_imagem_gravador});
...
/*********************** *************** ************************/
    ...
    const incluirArmario = (event) => {
      ...
      aoEnviarSugestao({armario: info_armario, imagem_armario: info_imagem_armario});
...
/*********************** ***************** ************************/
    ...
    const incluirAcessorio = (event) => {
      ...
      // Incluir acessório
      if(destaque.classList.contains('sugestao-destaque') == true) { 

        info_acessorio = info_acessorio + ' + ' + sistemaSugestao.acessorios ;
        ...
        //  Remover acessório
        info_acessorio = sistemaSugestao.acessorios ;
      ...
      aoEnviarSugestao({acessorios: info_acessorio});
...
/*********************** ************** ************************/
    ...
    function adicionaModulo() {
      ...
      if(sistemaSugestao.monitor != '') { opacidade_modulo_monitor = 0.5 }
      if(sistemaSugestao.insuflador != '') { opacidade_modulo_insuflador = 0.5 }
      if(sistemaSugestao.camera != '') { opacidade_modulo_camera = 0.5 }
      if(sistemaSugestao.luz != '') { opacidade_modulo_luz = 0.5 }
      if(sistemaSugestao.gravador != '') { opacidade_modulo_gravador = 0.5 }
      if(sistemaSugestao.armario != '') { opacidade_modulo_armario = 0.5 }
      if(sistemaSugestao.acessorios != '') { opacidade_modulo_acessorios = 0.5 }
    ...
    >
      <Grid container spacing={0}>
          ...
          <Grid item xs={10}>
              <DialogTitle id="max-width-dialog-title" className="sugestao-titulo-opcao">ADICIONAR MÓDULO</DialogTitle>
          </Grid>
        ...
        <Grid item xs={6} md={6} className="imagem">
                <div className="sistema-personalizado-imagem" style={{textAlign:'center',position:'relative',height:'568px'}}>
                        ...
                        <div className="imagem-auxiliar-posicao-3">
                            <a href="#" className="destaque" onClick={handleClickOpenMonitores}> <img src={ sistemaSugestao.imagem_monitor } alt="Monitor" className="tamanho-maximo monitor" /></a>
                        </div>

                        <div className="imagem-auxiliar-posicao-4">
                            <a href="#" className="destaque" onClick={handleClickOpenInsufladores}><img src={ sistemaSugestao.imagem_insuflador } alt="Insuflador" className="tamanho-maximo insuflador" /></a>
                        </div>

                        <div className="imagem-auxiliar-posicao-5">
                            <a href="#" className="destaque" onClick={handleClickOpenCameras}><img src={ sistemaSugestao.imagem_camera } alt="Camera" className="tamanho-maximo camera" /></a>
                        </div>

                        <div className="imagem-auxiliar-posicao-6">
                            <a href="#" className="destaque" onClick={handleClickOpenLuzes}><img src={ sistemaSugestao.imagem_luz } alt="Luz" className="tamanho-maximo luz" /></a>
                        </div>

                        <div className="imagem-auxiliar-posicao-7">
                             <a href="#" className="destaque" onClick={handleClickOpenGravadores}><img src={ sistemaSugestao.imagem_gravador } alt="Gravador" className="tamanho-maximo gravador" /></a>
                        </div>
                </div>
        </Grid>
          ...
          <div className="sistema-personalizado-texto" style={{position:'relative',height:'568px'}}>
            ...
            {sistemaSugestao.monitor != '' &&
              <div className="texto-auxiliar-posicao-3">
                    ...
                    <a href="#" className="destaque" onClick={handleClickOpenMonitores}>{sistemaSugestao.monitor}</a>
                    <div className="linha-destaque monitor"></div>
              </div>
            }

           {sistemaSugestao.insuflador != '' &&
            <div className="texto-auxiliar-posicao-4">
                ...
                <a href="#" className="destaque" onClick={handleClickOpenInsufladores}>{sistemaSugestao.insuflador}</a>
                <div className="linha-destaque insuflador"></div>
            </div>
           }

           {sistemaSugestao.camera != '' &&
            <div className="texto-auxiliar-posicao-5">
                ...
                <a href="#" className="destaque" onClick={handleClickOpenCameras}>{sistemaSugestao.camera}</a>
           ...
           {sistemaSugestao.luz != '' &&
              ...
              <div className="texto-auxiliar-posicao-6">
                  ...
                  <a href="#" className="destaque" onClick={handleClickOpenLuzes}>{sistemaSugestao.luz}</a>
                  <div className="linha-destaque luz"></div>
              </div>

           }

           {sistemaSugestao.gravador != '' &&
              ...
              <div className="texto-auxiliar-posicao-7">
                ...
                <a href="#" className="destaque" onClick={handleClickOpenGravadores}>{sistemaSugestao.gravador}</a>
                <div className="linha-destaque gravador"></div>
              </div>
           
           }

          {((sistemaSugestao.armario != '') || (sistemaSugestao.acessorios != '')) &&

            <div className="texto-auxiliar-posicao-8">
                <a href="#" className="acessorios" onClick={handleClickOpenArmarios}>{sistemaSugestao.armario} </a> <a href="#" className="acessorios" onClick={handleClickOpenAcessorios}>{sistemaSugestao.acessorios}</a>
            </div>
